...
# #+REVEAL_MULTIPLEX_SECRET: "thisisasecret"
# #+REVEAL_MULTIPLEX_SOCKETIO_URL: "http://localhost:8080/socket.io"
# #+REVEAL_ADD_PLUGIN: seminar RevealSeminar https://cdn.jsdelivr.net/gh/rajgoel/reveal.js-plugins/seminar/plugin.js
# #+REVEAL_INIT_SCRIPT: seminar: {
# #+REVEAL_INIT_SCRIPT: server: 'http://localhost:8080/socket.io',
# #+REVEAL_INIT_SCRIPT: room: 'My Room',
# #+REVEAL_INIT_SCRIPT: hash: '$2a$05$hhgakVn1DWBfgfSwMihABeYToIBEiQGJ.ONa.HWEiNGNI6mxFCy8S',
# #+REVEAL_INIT_SCRIPT: autoJoin: true
# #+REVEAL_INIT_SCRIPT: },
# #+REVEAL_ADD_PLUGIN: polls RevealPolls https://cdn.jsdelivr.net/gh/rajgoel/reveal.js-plugins/polls/plugin.js
# #+REVEAL_ADD_PLUGIN: questions RevealQuestions https://cdn.jsdelivr.net/gh/rajgoel/reveal.js-plugins/questions/plugin.js
